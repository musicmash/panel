    ...
    <div class="release">
        ...
        <div class="release-details">
            ...
            <div class="release-artist">
                <span>by&nbsp;</span>
                <a href="#" class="release-artist-link">{{
                    release.artist_name
                }}</a>
            </div>
