<template>
    <div class="artist">
        <div class="artist-poster">
            <img class="artist-poster-img" :src="artist.poster" alt="" />
        ...
        <div class="artist-details d-flex justify-content-center">
            <div class="artist-name">
                <a href="#" class="artist-link">{{ artist.name }}</a>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        toggle() {
            console.log("artist toggled", this.isSubscribed);
...
.artist > .artist-poster:hover > .artist-poster-img {
    opacity: 0.7;
    cursor: pointer;
}
.artist > .artist-poster > .action > .action-item > .action-item-btn:hover {
    cursor: pointer;
    transform: scale3d(1.2, 1.2, 1.2);
    -webkit-transform: scale3d(1.2, 1.2, 1.2);
}
.artist > .artist-poster:hover > .action > .action-item {
    opacity: 1;
    -webkit-transition-duration: 0.15s;
    transition-duration: 0.15s;
    -webkit-transition-property: opacity, -webkit-transform;
